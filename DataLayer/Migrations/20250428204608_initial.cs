        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstCountryAlphaCode = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Countries", x => x.AlphaCode);
                    table.ForeignKey(
                        name: "FK_Countries_BucketLists_BucketListId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Places_BucketLists_BucketListId",
                        column: x => x.BucketListId,
                        principalTable: "BucketLists",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Places_Countries_CoutryAlphaCode",
                        column: x => x.CoutryAlphaCode,
                        principalTable: "Countries",
                        principalColumn: "AlphaCode",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Countries_BucketListId",
                table: "Countries",
                column: "BucketListId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Places_CoutryAlphaCode",
                table: "Places",
                column: "CoutryAlphaCode");
